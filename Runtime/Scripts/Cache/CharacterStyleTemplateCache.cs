...
{
    public class CharacterStyleTemplateCache : CacheBase
    {
        public CharacterStyleTemplateCache() : base("Character Templates Links")
        {
            
        }
        
        public void Save(Object template, string id)
        {
        ...
        private static GUID FindAssetGuid(Object asset)
        {
