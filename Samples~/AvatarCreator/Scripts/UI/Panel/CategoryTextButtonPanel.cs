...
namespace ReadyPlayerMe.Samples.AvatarCreator
{
    ...
    public class CategoryTextButtonPanel : MonoBehaviour
    {
        ...
        [SerializeField] private CategoryText[] categoryIconAssets;
        ...
        public async void LoadCategories()
        {
            ...
            foreach (var category in categories)
            {
                ...
                CategoryText? categoryIconAsset = categoryIconAssets.FirstOrDefault(x => category.Contains(x.CategoryName));
