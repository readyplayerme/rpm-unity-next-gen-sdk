...
namespace ReadyPlayerMe.Demo
{
    ...
    public class EventAggregator
    {
        ...
        public event Action<Asset> OnAssetEquipped;
        public event Action<Asset> OnAssetUnequipped; 
        ...
        public void RaiseAssetEquipped(Asset asset)
        {
            OnAssetEquipped?.Invoke(asset);
        }
        
        public void RaiseAssetUnequipped(Asset asset)
        {
            OnAssetUnequipped?.Invoke(asset);
        }
    }
}
